...
export interface DeliveryPackage { id: string; trackingCode: string; rawBarcode?: string; recipient?: string; address: string; latitude: number; longitude: number; status: PackageStatus; vehiclePosition?: string }
